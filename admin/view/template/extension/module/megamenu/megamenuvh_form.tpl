			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-megamenuvh-item" class="form-horizontal">
				...
				<div class="show_elements show_elements_category">			
					<div class="form-group required">
						...
						<div class="col-sm-9">
							<select onChange="sel_type_category()" name="menuvh[category_setting][variant_category]" id="input_variant_category" class="form-control">
								...
								<option value="full_masonry" <?php if(isset($variant_category) && ($variant_category == 'full_masonry')) { ?> selected="selected" <?php } ?>><?php echo $ns_type_dropdown_full_masonry; ?></option>
								<option value="full_image_masonry" <?php if(isset($variant_category) && ($variant_category == 'full_image_masonry')) { ?> selected="selected" <?php } ?>><?php echo $ns_type_dropdown_full_masonry_image; ?></option>
								<option value="full_3_level" <?php if(isset($variant_category) && ($variant_category == 'full_3_level')) { ?> selected="selected" <?php } ?>><?php echo $ns_type_dropdown_full_3_level; ?></option>
								<option value="full_3_level_image" <?php if(isset($variant_category) && ($variant_category == 'full_3_level_image')) { ?> selected="selected" <?php } ?>><?php echo $ns_type_dropdown_full_3_level_image; ?></option>
							</select>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group number_column_sc">
						<label class="col-sm-3 control-label" for="input-category_show_subcategory"><?php echo $number_of_column_sc; ?></label>
						<div class="col-sm-9">
							<select id="input-category_show_subcategory" name="menuvh[category_setting][number_column_sc]" class="form-control">
								<?php if (isset($number_column_sc) && ($number_column_sc == 6)) { ?>
									<option value="6" selected="selected">2</option>
									<option value="4">3</option>
									<option value="3">4</option>
									<option value="1-5">5</option>
								<?php } elseif($number_column_sc == 4) { ?>
									<option value="6">2</option>
									<option value="4" selected="selected">3</option>
									<option value="3">4</option>
									<option value="1-5">5</option>
								<?php } elseif($number_column_sc == 3) { ?>
									<option value="6">2</option>
									<option value="4">3</option>
				...
				<div class="show_elements show_elements_freelink">
					<div class="form-group required">
						<label class="col-sm-3 control-label" for="input_variant_freelink"><?php echo $ns_type_dropdown_list; ?></label>
						<div class="col-sm-9">
							<select onChange="sel_type_category()" name="menuvh[sfl][variant_category]" id="input_variant_freelink" class="form-control">
								...
								<option <?php if(isset($sfl['variant_category']) && ($sfl['variant_category'] == 'full_masonry')) { ?> selected="selected" <?php } ?> value="full_masonry"><?php echo $ns_type_dropdown_full_masonry; ?></option>
								<option <?php if(isset($sfl['variant_category']) && ($sfl['variant_category'] == 'full_image_masonry')) { ?> selected="selected" <?php } ?> value="full_image_masonry"><?php echo $ns_type_dropdown_full_masonry_image; ?></option>
								<option <?php if(isset($sfl['variant_category']) && ($sfl['variant_category'] == 'full_3_level')) { ?> selected="selected" <?php } ?> value="full_3_level"><?php echo $ns_type_dropdown_full_3_level; ?></option>
							</select>
						</div>
					</div>
					...
					<div class="form-group freelink_number_column_sc">
						...
						<div class="col-sm-9">
							<select id="input-category_show_subcategory" name="menuvh[sfl][number_column_sc]" class="form-control">
								<?php if (isset($sfl['number_column_sc']) && ($sfl['number_column_sc'] == 6)) { ?>
									<option value="6" selected="selected">2</option>
									<option value="4">3</option>
									<option value="3">4</option>
									<option value="1-5">5</option>
								<?php } elseif($sfl['number_column_sc'] == 4) { ?>
									<option value="6">2</option>
									<option value="4" selected="selected">3</option>
									<option value="3">4</option>
									<option value="1-5">5</option>
								<?php } elseif($sfl['number_column_sc'] == 3) { ?>
									<option value="6">2</option>
									<option value="4">3</option>
									<option value="3" selected="selected">4</option>
									<option value="1-5">5</option>
