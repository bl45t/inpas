  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
	        <div class="col-md-12">
		        <div class="header_of_list ">
		            ...
		            <form action="<?=$search_link?>" method="post" class="search search_sub bd_search">
		            	<button type="button" id="filter_btn" class="bd_filtr">Фильтры</button>
		            	<input id="search_field_input" type="text" name="search_field" placeholder="поиск" class="input" value="<?=$search_field?>"/>
		        </div>
	    	</div>
    		...
    		<div id="filter_param" class="col-md-12 <?=$isHiddenFilter?>">
				...
				<div class="col-sm-3">
					<button type="submit" class=" bd_search_btn">Найти</button>
				</div>
